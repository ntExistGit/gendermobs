...
public class ModelElephant extends AdvancedEntityModel<EntityElephant> {
    ...
    public void animate(IAnimatedEntity entity, float f, float f1, float f2, float f3, float f4) {
        ...
        this.animator.rotate(this.head, Maths.rad((double)-25.0F), 0.0F, 0.0F);
        this.animator.rotate(this.left_ear, 0.0F, Maths.rad((double)25.0F), 0.0F);
        this.animator.rotate(this.right_ear, 0.0F, Maths.rad((double)-25.0F), 0.0F);
        this.animator.rotate(this.trunk1, Maths.rad((double)-65.0F), 0.0F, 0.0F);
        this.animator.rotate(this.trunk2, Maths.rad((double)-35.0F), 0.0F, 0.0F);
        this.animator.move(this.trunk2, 0.0F, -2.0F, 0.0F);
        this.animator.endKeyframe();
        this.animator.startKeyframe(5);
        this.animator.rotate(this.head, Maths.rad((double)-35.0F), 0.0F, 0.0F);
        this.animator.rotate(this.left_ear, 0.0F, Maths.rad((double)45.0F), 0.0F);
        this.animator.rotate(this.right_ear, 0.0F, Maths.rad((double)-45.0F), 0.0F);
        this.animator.rotate(this.trunk1, Maths.rad((double)-75.0F), 0.0F, 0.0F);
        this.animator.rotate(this.trunk2, Maths.rad((double)-55.0F), 0.0F, 0.0F);
        ...
        this.animator.startKeyframe(5);
        this.animator.rotate(this.head, Maths.rad((double)-25.0F), 0.0F, Maths.rad((double)-25.0F));
        this.animator.rotate(this.left_ear, 0.0F, Maths.rad((double)25.0F), 0.0F);
        this.animator.rotate(this.right_ear, 0.0F, Maths.rad((double)-25.0F), 0.0F);
        this.animator.rotate(this.trunk1, Maths.rad((double)-75.0F), Maths.rad((double)25.0F), 0.0F);
        this.animator.rotate(this.trunk2, Maths.rad((double)-35.0F), Maths.rad((double)10.0F), 0.0F);
        this.animator.move(this.trunk2, 0.0F, -2.0F, 0.0F);
        this.animator.endKeyframe();
        this.animator.startKeyframe(5);
        this.animator.rotate(this.head, Maths.rad((double)-25.0F), 0.0F, Maths.rad((double)25.0F));
        ...
        this.animator.rotate(this.body, Maths.rad((double)15.0F), 0.0F, 0.0F);
        this.animator.rotate(this.head, Maths.rad((double)-30.0F), 0.0F, 0.0F);
        this.animator.rotate(this.right_ear, 0.0F, Maths.rad((double)-20.0F), 0.0F);
        this.animator.rotate(this.left_ear, 0.0F, Maths.rad((double)20.0F), 0.0F);
        this.animator.rotate(this.left_arm, Maths.rad((double)-15.0F), 0.0F, Maths.rad((double)-15.0F));
        this.animator.rotate(this.right_arm, Maths.rad((double)-15.0F), 0.0F, Maths.rad((double)15.0F));
        this.animator.rotate(this.left_leg, Maths.rad((double)-15.0F), 0.0F, 0.0F);
        this.animator.rotate(this.right_leg, Maths.rad((double)-15.0F), 0.0F, 0.0F);
        this.animator.rotate(this.trunk1, Maths.rad((double)-15.0F), 0.0F, 0.0F);
        this.animator.rotate(this.trunk2, Maths.rad((double)45.0F), 0.0F, 0.0F);
        ...
        this.animator.startKeyframe(10);
        this.animator.rotate(this.body, Maths.rad((double)-35.0F), 0.0F, 0.0F);
        this.animator.rotate(this.head, Maths.rad((double)-10.0F), 0.0F, 0.0F);
        this.animator.rotate(this.left_leg, Maths.rad((double)35.0F), 0.0F, 0.0F);
        this.animator.rotate(this.right_leg, Maths.rad((double)35.0F), 0.0F, 0.0F);
        this.animator.rotate(this.left_arm, Maths.rad((double)35.0F), Maths.rad((double)-15.0F), 0.0F);
        this.animator.rotate(this.right_arm, Maths.rad((double)35.0F), Maths.rad((double)15.0F), 0.0F);
        this.animator.rotate(this.trunk1, Maths.rad((double)-15.0F), 0.0F, 0.0F);
        this.animator.rotate(this.trunk2, Maths.rad((double)45.0F), 0.0F, 0.0F);
        this.animator.rotate(this.tail, Maths.rad((double)45.0F), 0.0F, 0.0F);
        this.animator.move(this.body, 0.0F, -6.0F, 0.0F);
        this.animator.move(this.trunk2, 0.0F, -2.0F, 0.0F);
        this.animator.move(this.left_leg, 0.0F, -1.0F, 0.0F);
        this.animator.move(this.right_leg, 0.0F, -1.0F, 0.0F);
        ...
        this.animator.startKeyframe(10);
        this.animator.rotate(this.head, Maths.rad((double)15.0F), 0.0F, 0.0F);
        this.animator.rotate(this.left_ear, 0.0F, Maths.rad((double)25.0F), 0.0F);
        this.animator.rotate(this.right_ear, 0.0F, Maths.rad((double)-25.0F), 0.0F);
        this.animator.rotate(this.trunk1, Maths.rad((double)10.0F), 0.0F, 0.0F);
        this.animator.rotate(this.trunk2, Maths.rad((double)15.0F), 0.0F, 0.0F);
        this.animator.move(this.head, 0.0F, 3.0F, 0.0F);
        this.animator.endKeyframe();
        this.animator.startKeyframe(5);
        this.animator.move(this.head, 0.0F, -2.0F, -1.0F);
        this.animator.rotate(this.head, Maths.rad((double)-45.0F), 0.0F, 0.0F);
        this.animator.rotate(this.left_ear, 0.0F, Maths.rad((double)25.0F), 0.0F);
        this.animator.rotate(this.right_ear, 0.0F, Maths.rad((double)-25.0F), 0.0F);
        this.animator.rotate(this.trunk1, Maths.rad((double)-55.0F), 0.0F, 0.0F);
        this.animator.rotate(this.trunk2, Maths.rad((double)-55.0F), 0.0F, 0.0F);
        this.animator.move(this.trunk2, 0.0F, -2.0F, 0.0F);
        this.animator.endKeyframe();
        ...
        this.animator.rotate(this.head, Maths.rad((double)10.0F), 0.0F, 0.0F);
        this.animator.rotate(this.trunk1, Maths.rad((double)-45.0F), 0.0F, 0.0F);
        this.animator.rotate(this.trunk2, Maths.rad((double)120.0F), 0.0F, 0.0F);
        ...
        this.animator.startKeyframe(5);
        this.animator.rotate(this.head, Maths.rad((double)-5.0F), 0.0F, 0.0F);
        this.animator.rotate(this.left_ear, 0.0F, Maths.rad((double)5.0F), 0.0F);
        this.animator.rotate(this.right_ear, 0.0F, Maths.rad((double)-5.0F), 0.0F);
        this.animator.rotate(this.trunk1, Maths.rad((double)-40.0F), 0.0F, 0.0F);
        this.animator.rotate(this.trunk2, Maths.rad((double)-60.0F), 0.0F, 0.0F);
        this.animator.move(this.trunk2, 0.0F, -2.0F, 0.0F);
        this.animator.endKeyframe();
        this.animator.setStaticKeyframe(5);
        this.animator.resetKeyframe(5);
    ...
    public void m_7695_(PoseStack matrixStackIn, VertexConsumer bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
        if (this.f_102610_) {
            ...
            matrixStackIn.translate((double)0.0F, 2.8, (double)0.0F);
    ...
    public void setupAnim(EntityElephant entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.progressRotationPrev(this.body, standProgress, Maths.rad((double)-60.0F), 0.0F, 0.0F, 5.0F);
        this.progressRotationPrev(this.tail, standProgress, Maths.rad((double)60.0F), 0.0F, 0.0F, 5.0F);
        this.progressRotationPrev(this.right_arm, standProgress, Maths.rad((double)60.0F), Maths.rad((double)10.0F), 0.0F, 5.0F);
        this.progressRotationPrev(this.left_arm, standProgress, Maths.rad((double)60.0F), Maths.rad((double)-10.0F), 0.0F, 5.0F);
        this.progressRotationPrev(this.right_leg, standProgress, Maths.rad((double)60.0F), Maths.rad((double)-15.0F), 0.0F, 5.0F);
        this.progressRotationPrev(this.left_leg, standProgress, Maths.rad((double)60.0F), Maths.rad((double)15.0F), 0.0F, 5.0F);
        ...
        this.progressRotationPrev(this.tail, limbSwingAmount, Maths.rad((double)20.0F), 0.0F, 0.0F, 1.0F);
        this.progressRotationPrev(this.right_arm, sitProgress, Maths.rad((double)-90.0F), Maths.rad((double)10.0F), 0.0F, 5.0F);
        this.progressRotationPrev(this.left_arm, sitProgress, Maths.rad((double)-90.0F), Maths.rad((double)-10.0F), 0.0F, 5.0F);
        this.progressRotationPrev(this.right_leg, sitProgress, Maths.rad((double)90.0F), Maths.rad((double)5.0F), 0.0F, 5.0F);
        this.progressRotationPrev(this.left_leg, sitProgress, Maths.rad((double)90.0F), Maths.rad((double)-5.0F), 0.0F, 5.0F);
        ...
        this.progressRotationPrev(this.trunk1, sitProgress, Maths.rad((double)-45.0F), 0.0F, 0.0F, 5.0F);
        this.progressRotationPrev(this.trunk2, sitProgress, Maths.rad((double)60.0F), 0.0F, 0.0F, 5.0F);
        this.progressRotationPrev(this.tail, sitProgress, Maths.rad((double)50.0F), 0.0F, 0.0F, 5.0F);
