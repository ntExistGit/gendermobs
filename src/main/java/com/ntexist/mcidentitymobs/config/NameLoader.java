...
public class NameLoader {
    ...
    public static void loadNames() {
        try {
            ...
            Map<String, List<String>> data = ConfigManager.GSON.fromJson(
                    json,
    ...
    public static String getRandomName(Gender gender, RandomSource random) {
        List<String> list = gender == Gender.FEMALE ? femaleNames : maleNames;
