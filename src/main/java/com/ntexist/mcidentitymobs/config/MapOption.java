...
public class MapOption extends OptionEntry<Map<String, EntryData>> {
    ...
    protected void onReset() {
        Map<String, EntryData> resetMap = new LinkedHashMap<>();
        for (Map.Entry<String, EntryData> entry : defaultValue.entrySet()) {
            resetMap.put(entry.getKey(), new EntryData(entry.getValue()));
        }
