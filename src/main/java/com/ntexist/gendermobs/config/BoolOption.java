...
public class BoolOption extends OptionEntry<Boolean> {
    ...
    public List<AbstractWidget> build(int x, int y, int width) {
        ...
        toggle = Button.builder(
                Component.translatable(getter.get() ? "gendermobs.boolean.true" : "gendermobs.boolean.false"),
                btn -> {
                    boolean newVal = !getter.get();
                    setter.accept(newVal);
                    btn.setMessage(Component.translatable(newVal ? "gendermobs.boolean.true" : "gendermobs.boolean.false"));
                }
    ...
    protected void onReset() {
        ...
        toggle.setMessage(Component.translatable(defaultValue ? "gendermobs.boolean.true" : "gendermobs.boolean.false"));
    }
