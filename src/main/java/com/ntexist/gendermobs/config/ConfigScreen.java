...
public class ConfigScreen extends Screen {
    ...
    public ConfigScreen(Screen parent) {
        super(Component.translatable("gendermobs.config.title"));
        this.parent = parent;
    ...
    private void createTabs() {
        ...
        tabs.add(new Tab("gendermobs.config.tab.general", () -> {
            options.clear();
            options.add(new SpacerOption(12));

            options.add(new BoolOption(
                    "gendermobs.config.show_names",
                    "gendermobs.config.tooltip.show_names",
                    () -> ConfigManager.WORKING_COPY.general.showNames,
                    v -> ConfigManager.WORKING_COPY.general.showNames = v,
                    true));

            options.add(new BoolOption(
                    "gendermobs.config.colored_names",
                    "gendermobs.config.tooltip.colored_names",
            ...
            if (ModList.get().isLoaded("jade")) {
                options.add(new BoolOption(
                        "gendermobs.config.jade_icons",
                        "gendermobs.config.tooltip.jade_icons",
            ...
            options.add(new ColorOption(
                    "gendermobs.config.male_color",
                    "gendermobs.config.tooltip.male_color",
                    () -> ConfigManager.WORKING_COPY.colors.male,
                    v -> ConfigManager.WORKING_COPY.colors.male = v,
                    "#5555FF"));

            options.add(new ColorOption(
                    "gendermobs.config.female_color",
                    "gendermobs.config.tooltip.female_color",
                    () -> ConfigManager.WORKING_COPY.colors.female,
                    v -> ConfigManager.WORKING_COPY.colors.female = v,
                    "#FF55FF"));

            options.add(new BoolOption(
                    "gendermobs.config.use_default_names",
                    "gendermobs.config.tooltip.use_default_names",
            ...
            options.add(new ButtonOption(
                    "gendermobs.config.restore_default_names",
                    "gendermobs.config.tooltip.restore_default_names",
                    "gendermobs.config.button.action",
                    b -> ConfigManager.restoreDefaultNames()));

            options.add(new SpacerOption(12));
        }));

        tabs.add(new Tab("gendermobs.config.tab.vanilla_humanoid", () -> {
            options.clear();
            options.add(new SpacerOption(12));

            MapOption vanillaHumanoidOption = new MapOption(
                    "gendermobs.config.vanilla_humanoid",
                ...
                protected void onReset() {
                    setter.accept(new HashMap<>(ModConfig.defaultConfig().vanillaHumanoid));
        ...
        tabs.add(new Tab("gendermobs.config.tab.custom_humanoid", () -> {
            options.clear();
            options.add(new SpacerOption(12));

            MapOption customHumanoidOption = new MapOption(
                    "gendermobs.config.custom_humanoid",
                ...
                @Override
                protected void onReset() {
                    setter.accept(new HashMap<>(ModConfig.defaultConfig().customHumanoid));
                    if (this.rebuild != null) {
                        this.rebuild.run();
                    }
                }
        ...
        tabs.add(new Tab("gendermobs.config.tab.vanilla_non_humanoid", () -> {
            options.clear();
            options.add(new SpacerOption(12));

            MapOption vanillaNonHumanoidOption = new MapOption(
                    "gendermobs.config.vanilla_non_humanoid",
                ...
                @Override
                protected void onReset() {
                    setter.accept(new HashMap<>(ModConfig.defaultConfig().vanillaNonHumanoid));
                    if (this.rebuild != null) {
                        this.rebuild.run();
                    }
                }
        ...
        tabs.add(new Tab("gendermobs.config.tab.custom_non_humanoid", () -> {
            options.clear();
            options.add(new SpacerOption(12));

            MapOption customNonHumanoidOption = new MapOption(
                    "gendermobs.config.custom_non_humanoid",
                ...
                @Override
                protected void onReset() {
                    setter.accept(new HashMap<>(ModConfig.defaultConfig().customNonHumanoid));
                    if (this.rebuild != null) {
                        this.rebuild.run();
                    }
                }
        ...
        tabs.add(new Tab("gendermobs.config.tab.zombies", () -> {
            options.clear();
            options.add(new SpacerOption(12));

            ListOption zombiesOption = new ListOption(
                    "gendermobs.config.zombies",
        ...
        tabs.add(new Tab("gendermobs.config.tab.can_be_infected", () -> {
            options.clear();
            options.add(new SpacerOption(12));
    ...
    protected void init() {
        ...
        addRenderableWidget(Button.builder(
                        Component.translatable("gendermobs.gui.back"),
                        b -> Minecraft.getInstance().setScreen(parent)).bounds(40, height - 28, buttonWidth, 20)
                .build());

        addRenderableWidget(Button.builder(
                Component.translatable("gendermobs.gui.reset_all"),
                b -> {
        ...
        addRenderableWidget(Button.builder(
                Component.translatable("gendermobs.gui.done"),
                b -> {
