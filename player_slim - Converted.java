...
public class player_slim - Converted<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "player_slim_- converted"), "main");
	private final ModelPart head;
	private final ModelPart headwear;
	private final ModelPart body;
	private final ModelPart leftBrestPart;
	private final ModelPart rightBrestPart;
	...
	public player_slim - Converted(ModelPart root) {
		this.head = root.getChild("head");
		this.headwear = root.getChild("headwear");
		this.body = root.getChild("body");
		this.leftBrestPart = this.body.getChild("leftBrestPart");
		this.rightBrestPart = this.body.getChild("rightBrestPart");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition leftBrestPart = body.addOrReplaceChild("leftBrestPart", CubeListBuilder.create().texOffs(22, 20).addBox(-2.0F, -1.0F, -2.0F, 4.0F, 5.0F, 3.0F, new CubeDeformation(0.0F))
		.texOffs(22, 36).addBox(-2.0F, -1.0F, -2.0F, 4.0F, 5.0F, 3.0F, new CubeDeformation(0.25F)), PartPose.offsetAndRotation(2.0F, 2.0F, 0.0F, -0.3491F, 0.0F, 0.0F));

		PartDefinition rightBrestPart = body.addOrReplaceChild("rightBrestPart", CubeListBuilder.create().texOffs(18, 20).addBox(-2.0F, -1.0F, -2.0F, 4.0F, 5.0F, 3.0F, new CubeDeformation(0.0F))
		.texOffs(18, 36).addBox(-2.0F, -1.0F, -2.0F, 4.0F, 5.0F, 3.0F, new CubeDeformation(0.25F)), PartPose.offsetAndRotation(-2.0F, 2.0F, 0.0F, -0.3491F, 0.0F, 0.0F));
