...
public class ModelMoose extends AdvancedEntityModel<EntityMoose> {
    ...
    public Iterable<AdvancedModelBox> getAllParts() {
        return ImmutableList.of(this.root, this.left_ear, this.right_ear, this.head, this.neck, this.body,
                this.upper_body, this.beard, this.left_leg, this.right_leg, this.left_arm, this.right_arm,
    ...
    public void animate(IAnimatedEntity entity, float f, float f1, float f2, float f3, float f4) {
        ...
        this.animator.rotate(this.neck, Maths.rad((double) 50.0F), 0.0F, 0.0F);
        this.animator.rotate(this.head, Maths.rad((double) 4.0F), 0.0F, 0.0F);
        this.eatPose();
        this.animator.endKeyframe();
        this.animator.startKeyframe(4);
        this.animator.rotate(this.neck, Maths.rad((double) 70.0F), 0.0F, 0.0F);
        this.animator.rotate(this.head, Maths.rad((double) 10.0F), 0.0F, 0.0F);
        this.eatPose();
        this.animator.endKeyframe();
        this.animator.startKeyframe(4);
        this.animator.rotate(this.neck, Maths.rad((double) 50.0F), 0.0F, 0.0F);
        this.animator.rotate(this.head, Maths.rad((double) 0.0F), 0.0F, 0.0F);
        this.eatPose();
        this.animator.endKeyframe();
        this.animator.startKeyframe(4);
        this.animator.rotate(this.neck, Maths.rad((double) 70.0F), 0.0F, 0.0F);
        ...
        this.animator.rotate(this.neck, Maths.rad((double) -34.0F), 0.0F, 0.0F);
        this.animator.rotate(this.head, Maths.rad((double) -20.0F), 0.0F, 0.0F);
        this.animator.endKeyframe();
        this.animator.resetKeyframe(4);
    }

    private void eatPose() {
        this.animator.rotate(this.body, Maths.rad((double) 10.0F), 0.0F, 0.0F);
        this.animator.move(this.body, 0.0F, 2.0F, 0.0F);
        this.animator.rotate(this.left_leg, Maths.rad((double) -10.0F), 0.0F, 0.0F);
        this.animator.rotate(this.right_leg, Maths.rad((double) -10.0F), 0.0F, 0.0F);
        this.animator.rotate(this.left_arm, Maths.rad((double) -10.0F), 0.0F, Maths.rad((double) -10.0F));
        this.animator.rotate(this.right_arm, Maths.rad((double) -10.0F), 0.0F, Maths.rad((double) 10.0F));
    ...
    public void setupAnim(EntityMoose entityIn, float limbSwing, float limbSwingAmount, float ageInTicks,
        ...
        float jostleProgress = entityIn.prevJostleProgress
                + (entityIn.jostleProgress - entityIn.prevJostleProgress) * partialTick;
        float jostleAngle = entityIn.prevJostleAngle
                + (entityIn.getJostleAngle() - entityIn.prevJostleAngle) * partialTick;
        ...
        this.progressRotationPrev(this.neck, jostleProgress, Maths.rad((double) 7.0F), 0.0F, 0.0F, 5.0F);
        this.progressRotationPrev(this.head, jostleProgress, Maths.rad((double) 80.0F), 0.0F, 0.0F, 5.0F);
        ...
        if (jostleProgress > 0.0F) {
            float yawAmount = jostleAngle / (180F / (float) Math.PI) * 0.5F * jostleProgress * 0.2F;
            AdvancedModelBox var10000 = this.neck;
            var10000.rotateAngleY += yawAmount;
            var10000 = this.head;
            var10000.rotateAngleY += yawAmount;
            var10000 = this.head;
            var10000.rotateAngleZ += yawAmount;
        } else {
    ...
    public void renderToBuffer(PoseStack matrixStackIn, VertexConsumer bufferIn, int packedLightIn, int packedOverlayIn,
        ...
        if (this.young) {
            ...
            matrixStackIn.translate((double) 0.0F, (double) 2.25F, (double) 0.125F);
            this.parts().forEach((p_228292_8_) -> p_228292_8_.render(matrixStackIn, bufferIn, packedLightIn,
            ...
            matrixStackIn.pushPose();
            this.parts().forEach((p_228290_8_) -> p_228290_8_.render(matrixStackIn, bufferIn, packedLightIn,
                    packedOverlayIn, red, green, blue, alpha));
            matrixStackIn.popPose();
        }
